import type { Route } from "./+types/malowanie-na-zywo-krakow";
...
const city = getCity("malowanie-na-zywo-krakow")!;
...
export default function LivePaintingKrakow(props: Route.ComponentProps) {
