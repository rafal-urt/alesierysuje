...
export const WEDDING_PACKAGES = [
  {
    ...
    features: [
      ...
      "kącik live art - szybkie zdjęcie na miejscu, bez pozowania i kolejki",
  ...
  },
  {
    ...
    price: 6000,
    scope: "do 100 gości · do 30 ilustracji na żywo + do 10 z pracowni · 8 h",
    features: [
  ...
  },
  {
    ...
    price: 9000,
    scope: "duże wesela · do 30 ilustracji na żywo + do 30 z pracowni · 8 h",
    features: [
      "**do 30 ilustracji** gości malowanych na żywo - akwarela A5, papier 300 g",
      "**8 godzin** malowania na żywo",
