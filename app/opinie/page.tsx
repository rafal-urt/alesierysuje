    ...
    <main className="pt-16">
      <section className="py-20 px-6 bg-cream">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl text-dark leading-tight mb-4" style={{ fontFamily: "var(--font-playfair)" }}>
      ...
      <section className="py-20 px-6 text-center" style={{ background: "#fdf0ea" }}>
